const generateTeam = team => {
    ...
    <div class="card employee-card">
        ...
        <h3 class="card-title"><i class="fas fa=mug-hot mr-2">
        </i>${manager.getRole()}</h3>
            </div>
            <div class="card-body">
            <ul class="list-group">
    ...
    <h3 class="card-title"><i class="fas fa-glasses mr-2">
    </i>${engineer.getRole()}</h3>
        </div>
        <div class="card-body">
        <ul class="list-group">
            ...
            rel-"noopenernoreferrer">${engineer.getGithub()}</a></li>
    ...
    const generateIntern = intern => {
        ...
        <h3 class="card-title"><i class="fas fa-user-graduate mr-2">
        </i>${intern.getRole()}</h3>
            </div>
            <div class="card-body">
            <ul class="list-group">
